...
BEGIN
    ...
    -- RS2: Top 10 consumed items TODAY from POS sales only (SALE / CONSUMPTION).
    --      DAMAGE and TRANSFER_OUT are intentionally excluded — not the same as consumption.
    --      This section will populate once POS order integration writes SALE ledger entries.
    SELECT TOP 10
        i.IngredientsName    AS ItemName,
        ISNULL(i.Code, '')   AS ItemCode,
