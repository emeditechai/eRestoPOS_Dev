...
VALUES
    ...
    ('NAV_SETTINGS_BRANCH_MASTER', 'NAV_SETTINGS', 'Branch Master', 'Branch Master - add/edit branches', NULL, 'Master', 'BranchList', NULL, NULL, 'fas fa-code-branch compact-icon text-primary', 2, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_BRANCH_LOCATION', 'NAV_SETTINGS', 'Branch Location', 'Branch Location - manage location master', NULL, 'Master', 'BranchLocationList', NULL, NULL, 'fas fa-map-marker-alt compact-icon text-success', 3, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_DAYCLOSING', 'NAV_SETTINGS', 'Day Closing', NULL, NULL, 'DayClosing', 'Index', NULL, NULL, 'fas fa-cash-register compact-icon text-success', 4, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_USERS', 'NAV_SETTINGS', 'Users & Roles', NULL, NULL, 'User', 'UserList', NULL, NULL, 'fas fa-users compact-icon text-primary', 4, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_BANK', 'NAV_SETTINGS', 'Bank Master', NULL, NULL, 'Bank', 'Index', NULL, NULL, 'fas fa-university compact-icon text-primary', 5, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_STATIONS', 'NAV_SETTINGS', 'Stations', NULL, NULL, 'Kitchen', 'Stations', NULL, NULL, 'fas fa-map-signs compact-icon text-primary', 6, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_MENU_BUILDER', 'NAV_SETTINGS', 'Menu Builder', 'Maintain navigation menus', NULL, 'MenuManagement', 'Index', NULL, NULL, 'fas fa-sitemap compact-icon text-info', 7, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_ROLE_MENU', 'NAV_SETTINGS', 'Role Menu Mapping', 'Assign menus to roles', NULL, 'RoleMenuMapping', 'Index', NULL, NULL, 'fas fa-project-diagram compact-icon text-warning', 8, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_ROLE_PERMISSIONS', 'NAV_SETTINGS', 'Role Permission Matrix', 'Grant CRUD permissions', NULL, 'RolePermission', 'Index', NULL, NULL, 'fas fa-user-shield compact-icon text-danger', 9, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_AUDIT', 'NAV_SETTINGS', 'Audit Trail', 'Order modification history', NULL, 'AuditTrail', 'Index', NULL, NULL, 'fas fa-history compact-icon text-warning', 10, 1, 1, NULL, NULL, 0),
    ('NAV_SETTINGS_MAIL', 'NAV_SETTINGS', 'Mail Configuration', 'Email/SMTP server settings', NULL, 'MailConfiguration', 'Index', NULL, NULL, 'fas fa-envelope-open-text compact-icon text-info', 11, 1, 1, NULL, NULL, 0),
