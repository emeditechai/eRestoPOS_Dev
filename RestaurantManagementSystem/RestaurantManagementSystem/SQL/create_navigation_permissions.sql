...
VALUES
    ...
    ('NAV_SETTINGS_DAYCLOSING', 'NAV_SETTINGS', 'Day Closing', NULL, NULL, 'DayClosing', 'Index', NULL, NULL, 'fas fa-cash-register compact-icon text-success', 3, 1, 1, NULL, NULL, 0),
