    ...
    public class SettingsController : Controller
    {
        ...
        private RestaurantSettingsViewModel MapToViewModel(RestaurantSettings model)
        {
            return new RestaurantSettingsViewModel
            {
                ...
                IsReqAutoSentbillEmail = model.IsReqAutoSentbillEmail,
                    IsTableMarkedAvailableAfterBillCompletion = model.IsTableMarkedAvailableAfterBillCompletion,
                ...
                IsESCPOSPrintEnabled = model.IsESCPOSPrintEnabled,
                ESCPOSMode = model.ESCPOSMode ?? "BLE",
                ESCPOSPrinterIP = model.ESCPOSPrinterIP,
                ESCPOSPrinterPort = model.ESCPOSPrinterPort > 0 ? model.ESCPOSPrinterPort : 9100,
                ESCPOSPaperSize = model.ESCPOSPaperSize ?? "58mm",
        ...
        private RestaurantSettings MapToModel(RestaurantSettingsViewModel viewModel)
        {
            return new RestaurantSettings
            {
                ...
                IsTableMarkedAvailableAfterBillCompletion = viewModel.IsTableMarkedAvailableAfterBillCompletion,
                ...
                IsESCPOSPrintEnabled = viewModel.IsESCPOSPrintEnabled,
                ESCPOSMode = viewModel.ESCPOSMode ?? "BLE",
                ESCPOSPrinterIP = viewModel.ESCPOSPrinterIP,
                ESCPOSPrinterPort = viewModel.ESCPOSPrinterPort > 0 ? viewModel.ESCPOSPrinterPort : 9100,
                ESCPOSPaperSize = viewModel.ESCPOSPaperSize ?? "58mm",
