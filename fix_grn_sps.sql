...
-- ══════════════════════════════════════════════════════════════════════
-- usp_SaveGRN — auto-recalculate header totals from computed columns
-- Note: AcceptedQty, GSTAmount, LineAmount are persisted computed columns
-- ══════════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    -- Insert base columns only (AcceptedQty, GSTAmount, LineAmount are computed)
...
-- ══════════════════════════════════════════════════════════════════════
-- usp_PostGRN — recalculate totals from computed columns when posting
-- ══════════════════════════════════════════════════════════════════════
...
PRINT 'Done: usp_SaveGRN + usp_PostGRN fixed.';
GO
